  ...
  return (
    ...
    >
      <Modal.Header closeButton>
        <Modal.Title> {!offerItem ? "Update Offer" : "Create Offer"}</Modal.Title>
      </Modal.Header>
      <Modal.Body>
        {!offerItem || offerItem?.is_published===0 ? <Form onSubmit={handleSubmit(onSubmit)}>
          ...
          <Form.Group className="mb-1">
            ...
            <Form.Control
              ...
              {...register("start_date", { required: false,
                validate: (value) =>
                  !watch("end_date") || new Date(value) < new Date(watch("end_date")) || "Start date must be earlier than end date",
               })}
          ...
          <Form.Group className="mb-1">
            ...
            <Form.Control
              ...
              {...register("end_date", { required: false,
                validate: (value) =>
                  !watch("start_date") || new Date(value) > new Date(watch("start_date")) || "End date must be later than start date",
               })}
        ...
        </Form>: "For update you need to unpublish offer"}
      </Modal.Body>
    </Modal>
  );
};
